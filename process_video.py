...
from s3.inference.utils.results_utils import ResultSaver
...
def process_video(cfg: DictConfig):
    ...
    print(f'Loading s3 and weights')
    s3 = s3(cfg).to(device).eval()
...
if __name__ == '__main__':
    ...
    initialize(version_base='1.3.2', config_path="s3/config", job_name="process_video")
