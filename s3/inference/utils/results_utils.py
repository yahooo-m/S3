...
from s3.utils.pano_utils import ID2RGBConverter
from s3.utils.palette import davis_palette_np
from s3.inference.object_manager import ObjectManager
from s3.inference.object_info import ObjectInfo
...
def save_result(queue: Queue):
    while True:
        ...
        if saver.save_scores:
            ...
            if last_frame:
                tmp_to_obj_mapping = {obj: tmp_id for obj, tmp_id in tmp_id_to_obj.items()}#remove obj.id
