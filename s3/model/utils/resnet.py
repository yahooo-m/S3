...
def resnet18(pretrained=True, extra_dim=0):
    ...
    if pretrained:
        load_weights_add_extra_dim(model, torch.load('/home/deshui/pro/vos_pro/s3/saved_models/resnet18-5c106cde.pth'), extra_dim)
    return model
...
def resnet50(pretrained=True, extra_dim=0):
    ...
    if pretrained:
        load_weights_add_extra_dim(model, torch.load('/code/s3/saved_models/resnet50-19c8e357.pth'), extra_dim)
    return model
