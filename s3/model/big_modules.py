...
from s3.model.group_modules import *
from s3.model.utils import resnet
...
#         self.sensory_update = SensoryUpdater([up_dims[0], up_dims[1], up_dims[3] + 1], sensory_dim,
#                                              sensory_dim)

#         self.decoder_feat_proc = DecoderFeatureProcessor(ms_image_dims[1:], up_dims[:-1])   # f32 从1024变成512尺度
#         self.up_32_16 = MaskUpsampleBlock_32(up_dims[2], up_dims[0])
#         self.up_16_8 = MaskUpsampleBlock(up_dims[0], up_dims[1])
#         self.up_8_4 = MaskUpsampleBlock(up_dims[1], up_dims[3])
...
#         #print(ms_image_feat[-1].size())
#         f8, f4, f32 = self.decoder_feat_proc(ms_image_feat[1:])   # adapter 有f32
#         #print(f8.size(), f4.size(), f32.size())
#         if chunk_size < 1 or chunk_size >= num_objects:
#             chunk_size = num_objects
#             fast_path = True
#             new_sensory = sensory
