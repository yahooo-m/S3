...
class s3TrainWrapper(s3):
    def __init__(self, cfg: DictConfig, stage_cfg: DictConfig):
        ...
        self.move_reg_out_of_batch = Rearrange('(b t) q d -> b t q d', t=self.seq_length)
    ...
    def forward(self, data: Dict):
        ...
        def get_ms_feat_ti(ti):
            return [f[:, ti] for f in ms_feat]  # 1/16, 1/8, 1/4
...
#             reg = self.move_reg_out_of_batch(reg)
