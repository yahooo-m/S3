...
from s3.utils import palette

from s3.utils.palette import davis_palette, youtube_palette
import shutil
...
#     if 'Y' in args.dataset:
#         print('Making zip for YouTubeVOS...')
#         shutil.make_archive(path.join(args.output, 'y18-val-s2-mega-ms'), 'zip', args.output, 'Annotations')
